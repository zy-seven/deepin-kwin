...
void ScriptedQuickSceneEffect::setMetaData(const KPluginMetaData &metaData)
{
    ...
    const QString configFilePath = QStandardPaths::locate(QStandardPaths::GenericDataLocation, QLatin1String("deepin-kwin/effects/") + metaData.pluginId() + QLatin1String("/contents/config/main.xml"));
